...
class defineRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type defineRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type defineRequest
    let len;
    let data = new defineRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new defineRequest(null);
...
class defineResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type defineResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type defineResponse
    let len;
    let data = new defineResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new defineResponse(null);
...
module.exports = {
  ...
  datatype() { return 'srv_pkg/define'; }
};
